...
export default async function Page() {
  ...
  try {
    const statCardsRes = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/data/bikaner/competitive-analysis/stat-cards.json`,
      {
        cache: "no-store",
      }
    );
  ...
  try {
    const heatmapRes = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/data/bikaner/competitive-analysis/ad-frequency-heatmap.json`,
      {
        cache: "no-store",
      }
    );
  ...
  try {
    const sectorRes = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/data/bikaner/competitive-analysis/sector-ad-distribution.json`,
      {
        cache: "no-store",
      }
    );
  ...
  try {
    const dailyTrendsRes = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/data/bikaner/competitive-analysis/ad-daily-trends.json`,
      {
        cache: "no-store",
      }
    );
  ...
  try {
    const topAdRes = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/data/bikaner/competitive-analysis/top-ad-comparison.json`,
      {
        cache: "no-store",
      }
    );
  ...
  try {
    const untappedAdRes = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/data/bikaner/competitive-analysis/untapped-ad-table.json`,
      {
        cache: "no-store",
      }
    );
  ...
  try {
    const newAdRes = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/data/bikaner/competitive-analysis/new-ad.json`,
      {
        cache: "no-store",
      }
    );
  ...
  try {
    const sharedAdRes = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/data/bikaner/competitive-analysis/shared-ad.json`,
      {
        cache: "no-store",
      }
    );
  ...
  try {
    const marketShareRes = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/data/bikaner/competitive-analysis/market-share.json`,
      {
        cache: "no-store",
      }
    );
  ...
  try {
    const marketShareSecondsRes = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/data/bikaner/competitive-analysis/market-share-seconds.json`,
      {
        cache: "no-store",
      }
    );
