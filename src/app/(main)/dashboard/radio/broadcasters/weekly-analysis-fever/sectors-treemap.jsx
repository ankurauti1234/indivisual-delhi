...
const TVChannelTreemap = () => {
  ...
  const [selectedStation, setSelectedStation] = useState("Fever FM");
  ...
  const getTitle = () => {
    const weekDisplay = selectedWeek ===  "week25" ? "Week 25" : "Week 25";
